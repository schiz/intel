...
;(function($) {
    ...
    Plugin.prototype.setSlidesWidth = function(){
        $(this.element).find(this.options.itemSelector).width( this._config.$list.width() );
    };
...
define('modules/views/testPageView',[
	...
	var TestPageView = Backbone.View.extend({
		...
		setResultComputer: function(){
            ...
            //console.log(this.resultComputerImg);
		},
